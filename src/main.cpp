...
#include <vector>
#include <memory>
#include "GLViewFontModule.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewFontModule > glView( Aftr::GLViewFontModule::New( args ) );
